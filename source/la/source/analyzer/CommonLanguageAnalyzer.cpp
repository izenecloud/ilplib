...
int CommonLanguageAnalyzer<LanguageAction, BasicSentence>::analyze(
    IDManager* idm, const Term & input, TermIdList & output, analyzermode flags)
{
...
cout << ustring_convert_buffer1 << endl;
...
cout << "succ" << endl;
        ...
        for ( int i = 0; i < listSize; ++i )
        {
            ...
            for ( int j = 0; j < count; j++ )
            {
                ...
                {
                    char* termUstr = ustring_convert_buffer;
                    size_t termUstrLen = sizeof(UString::CharT) * UString::toUcs2(encode_, lexicon, len,
                                         (UString::CharT*)ustring_convert_buffer, 4096/sizeof(UString::CharT));
