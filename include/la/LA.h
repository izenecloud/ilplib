...
namespace la
{
    ...
    class LA 
    {
        ...
        public:
            typedef rde::hash_map<wiselib::UCS2Char, bool> PunctsType;
            ...
            void process_index( const wiselib::UString & inputString, TermList & outList );
            void process_search( const wiselib::UString & inputString, TermList & outList );
    ...
    wiselib::UString toExpandedString( const TermList & termList );
            //friend void makeString( const TermList & input, wiselib::UString & outputString );
